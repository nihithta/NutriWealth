...
const Profile = () => {
  ...
  const [localResources] = useState([
    {
      name: "Dr. Emily Chen",
      specialty: "Clinical Opthalmologist",
      distance: "0.8 miles",
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-semibold text-gray-700">Current Health Score:</h3>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-semibold text-gray-700">Average Health Score:</h3>
          </div>
          <p className="text-2xl font-bold text-gray-800">
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-8">
        <h2 className="text-xl font-bold text-gray-800 mb-6">Your Diet Journey</h2>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-8">
        <h2 className="text-xl font-bold text-gray-800 mb-6">Local Health Resources</h2>
