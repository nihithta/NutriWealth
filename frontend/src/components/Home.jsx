    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center">
          <h2 className="text-2xl font-semibold text-yellow-800 mb-4">Welcome to NutriWealth!</h2>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 rounded-3xl p-8 mb-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Connect with peers, track what you eat, get personal diet recommendations and find support in a safe, 
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <h3 className="text-xl font-semibold mb-2">Diet Tracking</h3>
          <p className="text-gray-600">
            Monitor what you eat and understand how its affecting your health.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <h3 className="text-xl font-semibold mb-2">Family Health</h3>
          <p className="text-gray-600">
            Find the best food recommendations for your family from stores near you.
          </p>
        </div>
      </div>
      ...
      {moodTracking && (
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-12">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Your Diet Journey</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-4 bg-blue-50 rounded-lg">
              <h4 className="text-sm font-medium text-gray-600 mb-1">Today's Food</h4>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-6 rounded-xl text-white">
          <h3 className="text-xl font-semibold mb-4">Schedule a Check-up</h3>
          <p className="mb-4">
            Get in touch with the best healthcare that's affordable to you.
          </p>
